...

{
    static partial class AsyncQueryable
    {
        ...
        /// </remarks>
        /// <param name="source">
        ///     <typeparamref name="TSource"/> 类型的值序列。
        /// </param>
        ...
        /// <summary>
        ///     异步计算通过对输入序列的每个元素调用投影函数获得的可空值序列的总和。
        /// </summary>
        /// <remarks>
        ///     同一上下文实例上不支持多个活动操作。请使用 'await' 确保在调用此上下文的另一个方法之前已完成任何异步操作。
        /// </remarks>
        ...
        /// <summary>
        ///     异步计算通过对输入序列的每个元素调用投影函数获得的整数值序列的总和。
        /// </summary>
        /// <remarks>
        ///     同一上下文实例上不支持多个活动操作。请使用 'await' 确保在调用此上下文的另一个方法之前已完成任何异步操作。
        /// </remarks>
        ...
        /// <summary>
        ///     异步计算通过对输入序列的每个元素调用投影函数获得的可空整数序列的总和。
        /// </summary>
        /// <remarks>
        ///     同一上下文实例上不支持多个活动操作。请使用 'await' 确保在调用此上下文的另一个方法之前已完成任何异步操作。
        /// </remarks>
        ...
        /// <summary>
        ///     异步计算通过对输入序列的每个元素调用投影函数获得的长整型值序列的总和。
        /// </summary>
        /// <remarks>
        ///     同一上下文实例上不支持多个活动操作。请使用 'await' 确保在调用此上下文的另一个方法之前已完成任何异步操作。
        /// </remarks>
        ...
        /// <summary>
        ///     异步计算通过对输入序列的每个元素调用投影函数获得的可空长整型序列的总和。
        /// </summary>
        /// <remarks>
        ///     同一上下文实例上不支持多个活动操作。请使用 'await' 确保在调用此上下文的另一个方法之前已完成任何异步操作。
        /// </remarks>
        ...
        /// <summary>
        ///     异步计算通过对输入序列的每个元素调用投影函数获得的双精度浮点数序列的总和。
        /// </summary>
        /// <remarks>
        ///     同一上下文实例上不支持多个活动操作。请使用 'await' 确保在调用此上下文的另一个方法之前已完成任何异步操作。
        /// </remarks>
        ...
        /// <summary>
        ///     异步计算通过对输入序列的每个元素调用投影函数获得的可空双精度浮点数序列的总和。
        /// </summary>
        /// <remarks>
        ///     同一上下文实例上不支持多个活动操作。请使用 'await' 确保在调用此上下文的另一个方法之前已完成任何异步操作。
        /// </remarks>
        ...
        /// <summary>
        ///     异步计算通过对输入序列的每个元素调用投影函数获得的单精度浮点数序列的总和。
        /// </summary>
        /// <remarks>
        ///     同一上下文实例上不支持多个活动操作。请使用 'await' 确保在调用此上下文的另一个方法之前已完成任何异步操作。
        /// </remarks>
        ...
        /// <summary>
        ///     异步计算通过对输入序列的每个元素调用投影函数获得的可空单精度浮点数序列的总和。
        /// </summary>
        /// <remarks>
        ///     同一上下文实例上不支持多个活动操作。请使用 'await' 确保在调用此上下文的另一个方法之前已完成任何异步操作。
        /// </remarks>
